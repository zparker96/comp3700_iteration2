...
public class CheckoutScreen extends JFrame {
    ...
    private JLabel labSubTotal = new JLabel("Subtotal: ");
    private JLabel labTax = new JLabel("Tax: ");
    ...
    public CheckoutScreen() {
        ...
        items.addColumn("Price/Unit");
        items.addColumn("Quantity");
        items.addColumn("Total Cost");
